function Banner() {
  ...
  return (
    <div  className="flex flex-col lg:flex-row lg:space-x-4 justify-between font-bold lg:mb-5 sm:mb-2 py-5 px-2 sm:px-10">
      <div className="">
      ...
      <p className="mt-5 md:mt-4 text-[#C5D2FC] max-w-sm font-normal sm:font-bold">
